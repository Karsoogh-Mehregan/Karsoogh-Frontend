...
export const timelineItems = [
  { title: 'ثبت‌نام', detail: 'تا ۲۰ خرداد مهلت ثبت‌نام وجود دارد.' },
...
export const faqItems = [
  ...
  },
  {
    ...
    answer: 'با کلیک روی دکمه ثبت‌نام به صفحه ثبت‌نام هدایت خواهید شد.',
  },
  {
    question: 'جایزه هم داره؟',
    answer:
      'معلومه که بله! راه‌یافتگان به مرحله تابستانه یادبودی از طرف تیم کارسوق دریافت می‌کنند و به دانش‌آموزان برتر نیز جوایز ارزنده‌ای تعلق می‌گیرد.',
  },
  {
